...
class PegawaiController extends Controller
{
   ...
   public function __construct()
    ...
    public function create()
    {
        ...
        $jabatan = Jabatan::all();
        return view('Pegawai.create',compact('user','golongan','jabatan')); 
    }
    ...
    public function show($id)
    {
        ...
        $golongan = Golongan::all();
        $jabatan = Jabatan::all();
        return view('Pegawai.show',compact('data','user','golongan','jabatan'));
    }
    ...
    public function edit( $id)
    {
        ...
        $wah =Jabatan::whereIn('id',[$pegawai->jabatan_id])->first();
              $jabatan = Jabatan::whereIn('id',[$pegawai->jabatan_id])->get();

        $ah=Golongan::whereIn('id',[$pegawai->golongan_id])->first();
        $golongan = Golongan::whereIn('id',[$pegawai->golongan_id])->get();
  
        return view('Pegawai.edit',compact('pegawai','golongan','jabatan','wah','ah'));
    }
