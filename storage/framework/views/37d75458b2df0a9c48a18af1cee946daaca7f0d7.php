                ...
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                     <h2><font face="Maiandra GD" color="white">Kategori Lembur</font></h2>
                        <hr class="star-light">
                         <h4><font face="Maiandra GD" color="white">hai <b><?php echo e(Auth::user()->name); ?></b> , Anda Memilih Kategori lembur</font></h4></div>
                    </div>
                    <?php endif; ?>
                    </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  &nbsp;&nbsp;&nbsp;<a href="<?php echo e(url('Kategori/create')); ?>" class="btn btn-primary">Tambah Kategori Lembur&nbsp;&nbsp;&nbsp;<i class="fa fa-pencil"></i></a>
                      ...
                      <tbody>
                         ...
                         <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <tr>
                                 ...
                                 <th><a href="<?php echo e(url('Kategori',$data->id)); ?>" class="btn btn-primary">lihat</i></a></th>
                                 <th><a title="Edit" href="<?php echo e(route('Kategori.edit',$data->id)); ?>" class="btn btn-warning">ubah</i></a></th>
                                 <th>
